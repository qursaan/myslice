"""Django implementation of the templating needed in Fed4FIRE.
"""
import pkgutil
import django.template
from django.conf import settings
import sla.slaclient

#
# Package where to read the template files
#
_package = "sla.slaclient.templates.fed4fire.django"
...
class Template(sla.slaclient.templates.Template):
