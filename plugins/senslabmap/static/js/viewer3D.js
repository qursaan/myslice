...
function init() {
    ...
    // jordan : modifier document.getElementById
    div3d = jQuery('#div3d');
    ...
    // jordan XXX div3d.appendChild(renderer.domElement);
    ...
    // set mouse event handlers // TODO jordan
...
function set3dsize() {
    ...
    offY = offset.top;
    offX = offset.left;
    window3DWidth = div3d.width();
    window3DHeight = div3d.height();
